...
var iah_el = document.createElement('p'),
  iah_normalizes, iah_ignoresEmptyText;
...
function insertAdjacentHTML(node, position, htmlContent) {
  if (node.insertAdjacentHTML) {
    ...
    if (iah_normalizes || iah_ignoresEmptyText) {
      var prevNode = (position === 'beforebegin') ? node.previousSibling : (position === 'beforeend') ? node.lastChild : null;
